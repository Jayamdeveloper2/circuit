                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">Card 3 content</label>
                                                        <div class="input-group mb-3">
                                            ...
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <textarea type="text" name="web_content_3" rows="15" class="form-control"><?= $data['web_content_3'] ?> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">Card 4 content</label>
                                                        <div class="input-group mb-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">Card 5</label>
                                                        <div class="input-group mb-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="form-label">Card 5 content</label>
                                                        <div class="input-group mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Image 1 (327px X 632px)</label>
                                                            <div class="product-img text-start">
                                                                ...
                                                                <img id="web_logo_1" src="<?= isset($data['image']) ? $data['image'] : '' ?>" height="120" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Image 2 (280px X 283px)</label>
                                                            <div class="product-img text-start">
                                                                <div class="input-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Image 3 (280px X 283px)</label>
                                                            <div class="product-img text-start">
                                                                <div class="input-group">
