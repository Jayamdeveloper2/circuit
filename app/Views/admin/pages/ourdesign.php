...
<style>
    ...
    <body class="hold-transition light-skin sidebar-mini theme-primary fixed">
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <div class="container-full">
                        ...
                        <div class="content-header mb-3">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <button data-pid="-1" class="btn btn-primary edit-servicecate"> 
                        ...
                        <div class="row">
                                ...
                                <div class="box shadow-none">
                                    <div class="box-body">
                                        ...
                                        <form class="form form-content mb-4">
                                            <div class="d-flex justify-content-between align-items-start mb-2">
                                                <div class="flex-grow-1">
                                                    ...
                                                    <div class="form-group mb-3 col-md-10 px-0">
                                                    ...
                                                    <div class="form-group mb-0 col-md-10 px-0">
                                                        <label class="form-label fw-bold">CTA Strip Content (Full Design Bundle)</label>
                                                        <div class="input-group">
                                                            <textarea class="form-control" name="web_content_3" placeholder="Enter CTA strip content..."><?= $data['web_content_3'] ?></textarea>
                                        ...
                                        <div class="table-responsive">
                                            <table id="servicecate_table" class="text-fade table table-bordered display">
                                            </table>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- Modal -->
                            <div id="servicecate-modal" class="modal modal-right fade" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-sm model_vs">
                                    <div class="modal-content">
                                        ...
                                        <form data-validate class="overflow-auto servicecate-form">
                                            ...
                                            <div class="modal-footer modal-footer-uniform w-100">
                                                <input type="hidden" name="web_service_cate_id" value="-1">
            ...
            <script src="<?= CSS_PATH ?>/js/pages/servicecate.js"></script>
    </body>
