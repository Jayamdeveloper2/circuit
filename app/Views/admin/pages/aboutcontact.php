                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="form-label">Image  (676px X 471px)</label>
                                                                <div class="input-group mb-3">
                                                                    <input type="file" name="web_image_1" class="form-control" accept=".jpg,.jpeg,.png">
                                                                    <div id="web_image_1_msg" class="text-danger"></div>
                                                                    <img id="web_image_1" src="<?= !empty($data['web_image_1']) ? CONTENT_IMG . $data['web_image_1'] : '' ?>" alt="" style="max-width: 200px; margin-top: 10px;">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
