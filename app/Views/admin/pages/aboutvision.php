                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="web_content_1" value="<?= $data['web_content_1'] ?? '' ?>" class="form-control" placeholder="More than projects. <span>A design hub</span>">
                                                </div>
                                                <div class="form-group">
                                                    <label class="form-label">Main Section Content</label>
                                                    <textarea name="web_content_2" rows="4" class="form-control"><?= $data['web_content_2'] ?? '' ?></textarea>
                                                </div>
                                            </div>

                                            <div class="col-md-6">
                                                <div class="box box-bordered border-primary">
                                                    <div class="box-header with-border"><h4 class="box-title">PERI Card Details</h4></div>
                                                    <div class="box-body">
                                                        <div class="form-group">
                                                            <label class="form-label">Card Title</label>
                                                            <input type="text" name="web_content_3" value="<?= $data['web_content_3'] ?? '' ?>" class="form-control" placeholder="Power Electronics Research Institute">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-label">Card Content</label>
                                                            <textarea name="web_content_4" rows="4" class="form-control"><?= $data['web_content_4'] ?? '' ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="product-img text-start">
                                                        ...
                                                        <img id="web_logo_1" src="<?= $data['image'] ?? '' ?>" height="150" class="mt-2" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
