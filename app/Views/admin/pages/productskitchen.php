...
<body class="hold-transition light-skin sidebar-mini theme-primary fixed">
    <div class="wrapper">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="product-img text-start">
                                                                ...
                                                                <div id="logo-photo-msg-1" class="text-danger"></div>
                                                                <img id="web_logo_1" src="<?= isset($data['web_image']) ? $data['web_image'] : '' ?>" height="120" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="product-img text-start">
                                                                ...
                                                                <div id="logo-photo-msg-2" class="text-danger"></div>
                                                                <img id="web_logo_2" src="<?= isset($data['image2']) ? $data['image2'] : '' ?>" height="120" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="product-img text-start">
                                                                ...
                                                                <div id="logo-photo-msg-3" class="text-danger"></div>
                                                                <img id="web_logo_3" src="<?= isset($data['image3']) ? $data['image3'] : '' ?>" height="120" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="product-img text-start">
                                                                <div class="input-group">
                                                                    <input type="file" name="web_image_4"
                                                                        class="form-control"
                                                                        accept=".jpg,.jpeg,.png">
                                                                </div>
                                                                <div id="logo-photo-msg-4" class="text-danger"></div>
                                                                <img id="web_logo_4" src="<?= isset($data['web_image4']) ? $data['web_image4'] : '' ?>" height="120" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="product-img text-start">
                                                                <div class="input-group">
                                                                    <input type="file" name="web_image_5"
                                                                        class="form-control"
                                                                        accept=".jpg,.jpeg,.png">
                                                                </div>
                                                                <div id="logo-photo-msg-5" class="text-danger"></div>
                                                                <img id="web_logo_5" src="<?= isset($data['web_image5']) ? $data['web_image5'] : '' ?>" height="120" alt="">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <script>
            ...
            handleImageInputChange("input[name=web_image_4]", "#web_logo_4", "#logo-photo-msg-4");
            handleImageInputChange("input[name=web_image_5]", "#web_logo_5", "#logo-photo-msg-5");
        </script>
        <script>
