                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <textarea type="text" name="web_content_2" rows="3" class="form-control"><?= $data['web_content_2'] ?> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="form-label">Card content 1</label>
            <div class="input-group mb-3">
                <textarea name="web_content_4" rows="10" class="form-control"><?= $data['web_content_4'] ?></textarea>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            <label class="form-label">Card content 2</label>
            <div class="input-group mb-3">
                <textarea name="web_content_6" rows="10" class="form-control"><?= $data['web_content_6'] ?></textarea>
            </div>
        </div>
    </div>
</div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label">Box Content</label>
                                                    <div class="input-group mb-3">
                                                        <textarea type="text" name="web_content_8" rows="n" class="form-control"><?= $data['web_content_8'] ?> </textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            $('textarea[name=web_content_8]').richText();
            // Image
