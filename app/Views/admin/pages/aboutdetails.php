                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" name="web_content_1" value="<?= $data['web_content_1'] ?>"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <textarea class="form-control" rows="5" name="web_content_2"><?= $data['web_content_2'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-10">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label class="form-label">Content</label>
                                                        <div class="input-group mb-3">
                                                            <textarea class="form-control" rows="5" name="web_content_4"><?= $data['web_content_4'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label class="form-label">Title</label>
                                                        <div class="input-group mb-3">
                                                            <input type="text" name="web_content_5" value="<?= $data['web_content_5'] ?>"
                                                                class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                                        <label class="form-label">Content</label>
                                                        <div class="input-group mb-3">
                                                            <textarea class="form-control" rows="5" name="web_content_6"><?= $data['web_content_6'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
