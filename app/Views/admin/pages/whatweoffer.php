    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="container-full">
                ...
                <!-- ===== GLOBAL EVENT ID (IMPORTANT) ===== -->
                <input type="hidden" id="web_event_id" value="<?= $event_id ?>">
                    ...
                    <div class="box">
                        <div class="box-body">
                            ...
                            <div class="table-responsive">
                                <table id="event_image_table" class="table table-bordered display"></table>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form class="image-form" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <!-- MODAL COPY (USED FOR SAVE ONLY) -->
                                        <input type="hidden" id="web_event_id" name="web_event_id" value="<?= $event_id ?>">

                                        <div class="form-group mb-3">
                                            <label>Title</label>
                                            <input type="text" id="web_title" name="web_title" class="form-control" required>
                                        </div>
        ...
        <script src="<?= CSS_PATH ?>/js/pages/event_images.js?v=<?= time() ?>"></script>
