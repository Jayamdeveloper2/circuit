                                            ...
                                            <div class="card-body p-4">
                                                <div class="row mb-4">
                                                    <div class="col-md-6">
                                                        <div class="form-group border-bottom pb-3">
                                                            <label class="form-label fs-12 text-muted text-uppercase fw-600">Section Title</label>
                                                            <input type="text" name="web_content_1" value="<?= htmlentities($data['web_content_1'] ?? '') ?>" class="form-control" placeholder="e.g. Engineering Assurance <span>Framework</span>">
                                                            <small class="text-muted">Tip: Use &lt;span&gt; around words you want highlighted in blue.</small>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group border-bottom pb-3">
                                                            <label class="form-label fs-12 text-muted text-uppercase fw-600">Section Subtitle (Link Text)</label>
                                                            <input type="text" name="web_content_4" value="<?= htmlentities($data['web_content_4'] ?? '') ?>" class="form-control" placeholder="e.g. Verified before fabrication — every time. Click here to know more">
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="section-item mb-3 border p-3 rounded" draggable="true">
                                                            <div class="row g-3 align-items-center">
                                                                ...
                                                                <div class="col-md-2">
                                                                    ...
                                                                    <input type="text" name="stats[<?= $index ?>][count]" value="<?= $stat['count'] ?? '' ?>" class="form-control form-control-sm" placeholder="e.g. 500">
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <label class="form-label fs-12 text-muted text-uppercase fw-600">Suffix</label>
                                                                    <input type="text" name="stats[<?= $index ?>][suffix]" value="<?= $stat['suffix'] ?? '' ?>" class="form-control form-control-sm" placeholder="e.g. +">
                                                                </div>
                                                                <div class="col-md-3">
                                                                    <label class="form-label fs-12 text-muted text-uppercase fw-600">Label</label>
                                                                    <input type="text" name="stats[<?= $index ?>][title]" value="<?= $stat['title'] ?? '' ?>" class="form-control form-control-sm" placeholder="e.g. Standards Verified">
                                                                </div>
                                                                <div class="col-md-4">
                                                ...
                                                <?php if (empty($stats)): ?>
                                                    <div id="no-stats-msg" class="text-center py-5 border rounded bg-light-soft">
                                                        <i class="fas fa-shield-alt fs-40 text-muted mb-3 d-block"></i>
                                                        <p class="text-muted mb-0">No framework added yet. Click "+ Add" to begin.</p>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                ...
                addBtn.addEventListener("click", function() {
                    ...
                    <div class="section-item mb-3 border p-3 rounded" draggable="true">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-2">
                                <label class="form-label fs-12 text-muted text-uppercase fw-600">Value</label>
                                <input type="text" name="stats[${index}][count]" class="form-control form-control-sm" placeholder="e.g. 500">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label fs-12 text-muted text-uppercase fw-600">Suffix</label>
                                <input type="text" name="stats[${index}][suffix]" class="form-control form-control-sm" placeholder="e.g. +">
                            </div>
                            <div class="col-md-3">
                                <label class="form-label fs-12 text-muted text-uppercase fw-600">Label</label>
                                <input type="text" name="stats[${index}][title]" class="form-control form-control-sm" placeholder="e.g. Standards Verified">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label fs-12 text-muted text-uppercase fw-600">Description</label>
