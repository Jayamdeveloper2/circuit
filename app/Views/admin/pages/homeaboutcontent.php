                                        ...
                                        <div class="row">
                                            ...
                                            <!-- <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <textarea type="text" name="web_content_2" rows="2" class="form-control"><?= $data['web_content_2'] ?> </textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="form-label">Content</label>
                                                            <div class="input-group mb-3">
                                                                <textarea type="text" name="web_content_3" rows="5" class="form-control"><?= $data['web_content_3'] ?> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div> -->
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Left card </label>
                                                            <div class="input-group mb-3">
                                                                <textarea id="editor1" name="web_content_4" rows="10" class="form-control"><?= $data['web_content_4'] ?> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="form-label">Right card </label>
                                                            <div class="input-group mb-3">
                                                                <textarea id="editor2" name="web_content_5" rows="10" class="form-control"><?= $data['web_content_5'] ?> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
