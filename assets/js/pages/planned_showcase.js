$(document).ready(function () {
    ...
    ClassicEditor
        .create(document.querySelector('#web_features_editor'))
        .then(editor => { featureEditor = editor; })
    ...
    const table = $('#plannedTable').DataTable({
        ...
        columns: [
            { data: "serial_no" },
            { data: "web_tag", render: (data) => `<span class="badge badge-lg badge-info-light">${data}</span>` },
            { data: "web_title", render: (data) => `<span class="fw-bold">${data}</span>` },
            { data: "theme_class", render: (data) => `<code class="small text-muted">${data}</code>` },
            { data: "display_order" },
            { 
                data: "is_active",
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status == 'success') {
                    ...
                    form.find('[name="web_planned_showcase_id"]').val(d.web_planned_showcase_id);
                    ...
                    form.find(`[name="is_active"][value="${d.is_active}"]`).prop('checked', true);
